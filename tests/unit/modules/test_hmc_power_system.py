...
test_data1 = [
    ...
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'poweroff', 'state': None, 'system_name': "system_name", 'metrics': None},
...
test_data2 = [
    ...
    # when hostname is missing
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'poweron', 'state': None, 'system_name': "system_name", 'metrics': None},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # when system_name is missing
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'action': 'poweron', 'system_name': None, 'state': None, 'metrics': None},
     "ParameterError: mandatory parameter 'system_name' is missing")]

test_data3 = [
    # All modify system_config data
    # when hostname is missing
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'modify_syscfg', 'state': None, 'system_name': "system_name", 'metrics': None},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # when system_name is missing
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'action': 'modify_syscfg', 'system_name': None, 'state': None, 'metrics': None},
     "ParameterError: mandatory parameter 'system_name' is missing"),
    ...
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'action': 'modify_syscfg', 'system_name': "system_name",
      ...
      'mem_mirroring_mode': 'sys_firmware_only', 'metrics': None},
...
test_data4 = [
    ...
    # when hostname is missing
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': 'modify_hwres', 'state': None, 'system_name': "system_name", 'metrics': None},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # when system_name is missing
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'action': 'modify_hwres', 'system_name': None, 'state': None, 'metrics': None},
     "ParameterError: mandatory parameter 'system_name' is missing"),
...
test_data5 = [
    ...
    # when hostname is missing
    ({'hmc_host': None, 'hmc_auth': hmc_auth, 'action': None, 'state': 'facts', 'system_name': "system_name", 'metrics': None},
     "ParameterError: mandatory parameter 'hmc_host' is missing"),
    # when system_name is missing
    ({'hmc_host': "0.0.0.0", 'hmc_auth': hmc_auth, 'action': None, 'system_name': None, 'state': 'facts', 'metrics': None},
     "ParameterError: mandatory parameter 'system_name' is missing"),
...
def test_call_inside_updatePCM(mocker, power_system_test_input, expectedError):
    hmc_power_system = common_mock_setup(mocker)
    if 'ParameterError' in expectedError:
        with pytest.raises(ParameterError) as e:
            hmc_power_system.updatePCM(hmc_power_system, power_system_test_input)
        assert expectedError == repr(e.value)
    else:
        hmc_power_system.updatePCM(hmc_power_system, power_system_test_input)
